...
'''
Description: This class is used for processing paths of files
Output: 
Input: Usually require the directory containing the files you want to process
Other notes:
'''
...
class FilePorcessor:
    ...
    def get_paired_seq_fpaths(self):
        ...
        for f_pair in self._in_lst_paired_fnames:
            print(f'Find paired files-->{f_pair["fname_r1"]}......{f_pair["fname_r2"]}')
